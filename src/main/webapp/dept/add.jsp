...
<body>
	...
	<form action="${title eq '입력'?'insert.do':'update.do' }" method="post">
		<div class="form-group">
			...
			<input name="deptno" id="bean.deptno" value="${bean.deptno }${deptno==0?'':deptno }" class="form-control"/>
		</div>	
		<div class="form-group">
			<label for="dname">dname</label><span>${FieldErrors.dname }</span>
			<input name="dname" id="bean.dname" value="${bean.dname }${dname }" class="form-control"/>
		</div>	
		<div class="form-group">
